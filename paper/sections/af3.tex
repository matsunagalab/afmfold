...
Specifically, while \AFiii employs Denoising Diffusion Probabilistic Models (DDPMs) following the variance-preserving (VP) formulation, we compute the likelihood of the generated structure with respect to the specified CVs and add to the original \AFiii score as a driving force that increases this likelihood. With this modified score, the generated structures becomes explicitly conditioned on the CVs.
...
The optimal select of $\eta_t$ is analyzed in SI section S1. 
