...
Our strategy is to use a \emph{group-equivariant} CNN (g-CNN) \cite{CohenWelling2016_GCNN, CohenWelling2017_SteerableCNNs, e2cnn, WeilerEtAl2018_3DSteerableCNNs} that estimates low-dimensional, structure-related collective variables (CVs)---such as distances between protein domains---directly from each AFM image, bypassing the need for explicit alignment altogether.
