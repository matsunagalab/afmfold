...
In this structural feature space, the \Model predictions (blue dots in \Cref{fig:resnet_embeddings}~(a, left)) cluster more closely around the experimental images (red stars) than the crystal structure does (green dots in \Cref{fig:resnet_embeddings}~(a, right)).
