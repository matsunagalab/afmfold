...
To construct the training data, we generated a conformational ensemble by navigating \AFiii to target CV values---defined as the inter-domain distances for all domain pairs (LID--CORE, CORE--AMPbd, and AMPbd--LID)---
...
We then trained the g-CNN on this ensemble and evaluated its estimation accuracy using pseudo-AFM images generated from randomly selected MD conformations.
