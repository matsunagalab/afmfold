...
Importantly, this degradation grows only gradually with the mismatch, so \Model still tolerates a moderate difference between the training and input noise levels.
These results indicate that it is important to add noise to the training images at a level comparable to that in the experimental images, although exact matching is not required.
