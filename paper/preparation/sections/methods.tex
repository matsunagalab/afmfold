...
In \Cref{subsec:gcnn}, we summarize the group-equivariant CNN used to estimate the CVs from AFM images.
In \Cref{subsec:navigating_af3}, we describe how we add restraints in the diffusion process of \AFiii using the estimated CVs.
In \Cref{subsec:protocol}, the overall computational protocol of our \Model framework is given.
