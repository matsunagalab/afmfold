...
The optimal selection of $\eta_t$ is analyzed in \textit{Navigating scheduling} in Appendices, and a concise summary of all key hyperparameters governing the guided diffusion process is provided in SI \Cref{tab:guidance_params}.
