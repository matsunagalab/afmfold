...
Let $\phi_{\text{target}} \in \mathbb{R}^D$ denote the target CV coordinate, where $D$ is the dimension of the CVs.
...
The optimal selection of $\eta_t$ is analyzed in \Cref{sec:nav_scheduling}, and a concise summary of all key hyperparameters governing the guided diffusion process is provided in \Cref{tab:guidance_params}.
