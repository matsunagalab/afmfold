...
from afmfold.configs.configs_inference import inference_configs
from afmfold.runner.dumper import DataDumper

from afmfold.protenix.config import parse_configs, parse_sys_args
from afmfold.protenix.data.infer_data_pipeline import get_inference_dataloader
...
from afmfold.protenix.utils.torch_utils import to_device
...
class InferenceRunner(object):
    ...
    # Adapted from afmfold.runner.train.Trainer.evaluate
    @torch.no_grad()
    ...
    for seed in configs.seeds:
        ...
        for batch in dataloader:
            try:
                ...
                # Modified in afmfold: update atom_array.
                runner.configs.guidance_kwargs.atom_array = atom_array
